...
This is the Second official version of the default texturepack for the [Emeralds Plus Mod](https://modrinth.com/mods/emeraldsplus)

#### Added Textures :

- Added the Emerald Enchantment Texture

# Its neccesary to install the mod,otherwise the texture pack will do nothing 
( I recommend to use the 2.0.0 mod file for this version )
...
| Textures | 0.9.0 | 0.9.1 | 0.9.2 | 1.0.0 | 2.0.0 | 2.1.0 | 2.2.0 |
|------|-------------|------|------|-------------|------|---|-|
